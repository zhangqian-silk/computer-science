...
| [Context Engineering](notes/context/context-engineering.md) | 注意力预算、失效模式、上下文操作与长程策略 |
...
| [context / memory / knowledge 边界](notes/context/context-boundaries.md) | 从无状态推出三套机制、两条判据、易混对象辨析、归属判断与排障 |
