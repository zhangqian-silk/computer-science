...
| Pi | [流式](model/llm-api.md#streaming)、[Loop](control/react-loop.md)、[压缩](context/compaction.md)、[扩展](tools/hooks-plugins.md) | transformContext 与 convertToLlm；Steering/Follow-up；有序历史；摘要边界与扩展错误 |
