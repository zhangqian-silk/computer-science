...
## 连续表示与神经语言模型：NPLM、Embedding、word2vec
...
## 自注意力与位置信息：Self-Attention、Positional Encoding

### Self-Attention：序列内部的全局交互
...
### Positional Encoding：为注意力补上顺序坐标
