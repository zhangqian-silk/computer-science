...
const modes = [
	...
	{ zh: "上下文混淆", en: "Context Confusion", why: "冗余内容被模型当作依据取用，最常见是工具过多、功能重叠导致选错。", fix: "裁出最小、不重叠的工具集；人也说不清何时该用的两个工具，应合并或删去一个。" },
	{ zh: "上下文冲突", en: "Context Clash", why: "新进入的信息或工具与既有内容直接矛盾，早期错误尝试持续拖累后续推理。", fix: "需求尽量一次给全；口径变更时显式声明「以下取代此前的 X」，必要时另开会话，而非在已污染的历史上局部修补。" }
]
</script>
